...
def log_data_callback(data):
    ...
    orientation_quaternion = [data.pose.pose.orientation.x, data.pose.pose.orientation.y, data.pose.pose.orientation.z, data.pose.pose.orientation.w]
...
def save_to_csv():
    csv_path = '/home/iascr/data/est_log.csv'
    ...
    print("Data disimpan dalam est_log.csv")

# Fungsi untuk menyimpan visualisasi sebagai gambar
def save_visualization():
    png_path = '/home/iascr/data/est_trajectory.png'
    plt.figure()
    ...
    print("Visualisasi disimpan sebagai est_trajectory.png")

def main():
    rospy.init_node('data_logger', anonymous=True)

    # Pengaturan subscriber ke topik /amcl_pose
    rospy.Subscriber('/amcl_pose', PoseWithCovarianceStamped, log_data_callback)
